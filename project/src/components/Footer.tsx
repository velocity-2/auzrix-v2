...
import { Instagram, Heart, Mail, Phone, MapPin, ArrowRight, Shield, Target, Sword } from "lucide-react";
...
const values = [
  { icon: Shield, text: 'Built with discipline' },
  { icon: Target, text: 'Driven by purpose' },
  { icon: Sword, text: 'Forged for warriors' }
];
...
const Footer: React.FC = () => {
  return (
    <footer className="bg-auzrix-black text-auzrix-white border-t border-auzrix-gray/10">
      {/* Upper Footer - Values */}
      <div className="border-b border-auzrix-gray/10">
            ...
            {values.map((value, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="flex items-center justify-center gap-4 text-auzrix-gray group"
                >
                  <div className="p-3 bg-auzrix-white/5 rounded-full group-hover:bg-auzrix-white/10 transition-colors">
                    <Icon className="w-6 h-6" />
                  </div>
                  <span className="font-cinzel tracking-wider">{value.text}</span>
                </motion.div>
              );
            })}
          </div>
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <div className="pt-4">
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="p-2 bg-auzrix-black border border-auzrix-gray/20 rounded-md hover:border-auzrix-white/40 transition-colors">
